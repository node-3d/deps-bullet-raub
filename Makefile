...
ifeq ($(OS), Windows)
	CC               = "C:/Program Files (x86)/Microsoft Visual Studio/2017/BuildTools/VC/Tools/MSVC/14.16.27023/bin/Hostx$(ARCH)/cl"
	CXX              = "C:/Program Files (x86)/Microsoft Visual Studio/2017/BuildTools/VC/Tools/MSVC/14.16.27023/bin/Hostx$(ARCH)/cl"
else
	CC               = gcc
	CXX              = g++
endif
...
ifeq ($(OS), Windows)
	$(TARGET): $(OBJECTS)
		$(LIBAPP) $(LIBFLAGS) /OUT:$(TARGET) $(OBJECTS)
